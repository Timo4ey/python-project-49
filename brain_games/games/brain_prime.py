...
def define_simple_numbers(num: int) -> str:
    i = 2
    # if i not bigger or equal square root of num we start or continue the cycle
    # because square root of num should be the highest number that we can division the number
    while i <= sqrt(num):
